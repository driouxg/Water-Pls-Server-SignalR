...
namespace SignalRTest.Domain.VO
{
    public class UserVo : ValueObject
    {
        ...
        public UserVo(ApplicationUser username, NameVo firstName, NameVo lastName, EmailVo email, AddressDto addressDto, GeoCoordinatesVo geoCoordinates, string clientConnection)
        {
